...
class Users(Controller):
    ...
    def show_user(self, user_id):
        ...
        user_info = self.models['User'].get_total_count_qoutes(user_id)
        print user_info
        quotes = self.models['User'].get_all_quotes(user_id)
        print quotes

        return self.load_view('show_user.html', user_info=user_info[0], quotes=quotes)
